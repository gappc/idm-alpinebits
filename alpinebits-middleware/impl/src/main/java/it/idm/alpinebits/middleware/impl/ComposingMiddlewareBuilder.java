...
public class ComposingMiddlewareBuilder {
     ...
     * When the {@link Middleware#handle(Context, MiddlewareChain)} method of
     ...
     *         {@link Middleware#handle(Context, MiddlewareChain)} method is called,
    ...
    public static Middleware compose(List<Middleware> incomingMiddlewares) {
        ...
        // Return a new middleware. When its handle method is called, it invokes the
